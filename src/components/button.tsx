...
export function Button(props: ButtonProps) {
  return (
    <a
      ...
      ${
        props.variant === "right"
          ? `after:absolute after:w-full after:h-full after:-z-10 after:left-2 after:top-2  after:bg-[#1D1E1F] 
      after:border-r-4 after:border-r-[#dac5a7] after:border-b-4 after:border-b-[#dac5a7] after:hover:top-0 after:hover:left-0 
      ...
      after:hover:right-0 after:transition-all after:duration-300`
      }`}
      {...props}
    >
      {props.children}
